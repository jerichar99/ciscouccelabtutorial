...
#Set-WindowsVMNetwork -vmName "AD-A.JLAB1.LOCAL" -adminPassword "P@ssword123!" -computerName "AD-A" -ipAddress "10.180.1.200" -gatewayIP "10.180.1.1" -dnsIP "127.0.0.1";
#Create-WindowsDomain -vmName "AD-A.JLAB1.LOCAL" -adminPassword "P@ssword123!" -domain "JLAB1.LOCAL" -domainPassword "P@ssword123!" -isNewForest:$true;
#Finish-WindowsAD -vmName "AD-A.JLAB1.LOCAL" -adminPassword "P@ssword123!" -reverseZone "10.180.1.0/24";


Install-WindowsVM -esxiHost "192.168.1.199" -vmName "AD-B.JLAB1.LOCAL" -numCPU 1 -memoryGB 3 -diskGB 50 -networkName "Private-SideB" -windowsISOPath "[datastore1] /ISOs/Windows_Server_2016_Datacenter_EVAL_en-us_14393_refresh.ISO" -vmwareToolsISOPath "[datastore1] /ISOs/vmwaretools_windows.iso" -floppyPath "[datastore1] /floppies/windowsFloppy.flp";
